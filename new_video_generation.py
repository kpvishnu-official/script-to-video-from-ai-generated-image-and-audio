...
class TextToVideoCreator:
    ...
    async def generate_tts(self, text, output_path='short_audio.mp3', voice='en-US-AriaNeural', style='narration-professional', rate='+0'):
        communicate_kwargs = {
            "text": text,
            "voice": voice,
            "rate": f"{rate}%"
...
if __name__ == "__main__":
    creator = TextToVideoCreator("test.json", 'assets', (1920, 1080))
    creator.run()
